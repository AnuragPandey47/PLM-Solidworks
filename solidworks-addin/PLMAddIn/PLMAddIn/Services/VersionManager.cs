...
namespace PLMAddIn.Services
{
    ...
    public class VersionManager
    {
        ...
        public VersionInfo CreateVersion(string workingFilePath, string notes = "")
        {
            ...
            // Save metadata using new method
            _metadataService.CreateVersionMetadata(versionDir, nextVersion, versionInfo.Author, notes);

            return versionInfo;
        }

        /// <summary>
        /// Gets version history for a file (not currently used in new architecture)
        /// </summary>
